...
def profiles_list_view(request):
    ...
    # qs =Profile.objects.all().exclude(user=user)    <---- Also we can use this way to define it
...
def invite_profiles_list_view(request):
    ...
    context={'qs':qs,'rel_sender':rel_sender,'rel_receiver':rel_receiver}
...
class ProfileListView(LoginRequiredMixin,ListView):
    ...
    context_object_name = 'qs'  # default in django gives item in object_list
...
def search(request):
    ...
    res=Profile.objects.filter(Q(slug__icontains=query) | Q(first_name__icontains=query)).exclude(user=request.user)
    ...
    context={'res':res,'rel_receiver':rel_receiver,'rel_sender':rel_sender}
